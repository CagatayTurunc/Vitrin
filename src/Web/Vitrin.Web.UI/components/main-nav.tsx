    ...
    <nav className="hidden lg:flex items-center space-x-1 pl-6">
      {navItems.map((navItem, index) => (
        <div key={index} className="relative group">
          <Link href={navItem.href} className="flex items-center gap-1.5 whitespace-nowrap px-3 py-2 text-sm font-medium text-muted-foreground hover:text-foreground transition-colors rounded-md hover:bg-muted/50">
            {navItem.title}
