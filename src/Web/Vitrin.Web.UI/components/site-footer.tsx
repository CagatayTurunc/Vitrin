...
const footerSections = {
  ...
  kategoriler: {
    title: "Kategoriler", 
    links: [
      { title: "Yapay Zeka", href: "/categories/yapay-zeka" },
      { title: "Tasarım", href: "/categories/tasarim" },
      { title: "Geliştirici Araçları", href: "/categories/gelistirici-araclari" },
      { title: "SaaS", href: "/categories/saas" },
      { title: "Açık Kaynak", href: "/categories/acik-kaynak" }
    ]
  },
  topluluk: {
    title: "Topluluk",
    links: [
      ...
      { title: "Topluluk Kuralları", href: "/community-rules" },
      { title: "Sıralama Sistemi", href: "/ranking-system" },
      ...
      <div className="mx-auto max-w-6xl px-4 py-12">
        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-6">
          ...
          <div className="col-span-2 space-y-4">
            ...
            <p className="text-sm text-muted-foreground max-w-xs leading-relaxed">
              En yeni ürünleri keşfedin, oy verin ve favori geliştiricilerinizi destekleyin. 
              Türkiye'nin ürün avcıları topluluğu.
            </p>
            <div className="flex items-center gap-3">
              <Link
                href="https://twitter.com/vitrinit"
              ...
              <Link
                href="https://github.com/CagatayTurunc/Vitrin"
                className="w-8 h-8 rounded-lg border border-border flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary/30 transition-colors"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="GitHub"
              ...
              <Link
                href="https://linkedin.com/company/vitrin"
                className="w-8 h-8 rounded-lg border border-border flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary/30 transition-colors"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
        ...
        <div className="mt-12 flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-border pt-8">
          <p className="text-xs text-muted-foreground">
            © 2026 Vitrin. Tüm hakları saklıdır.
          </p>
