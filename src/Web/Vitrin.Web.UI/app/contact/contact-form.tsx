                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid sm:grid-cols-2 gap-5">
                    <div className="space-y-2">
                      <label htmlFor="contact-name" className="text-sm font-medium text-foreground">Ad Soyad</label>
                      <Input
                        id="contact-name"
                        required
                        placeholder="Adınız"
                    ...
                    <div className="space-y-2">
                      <label htmlFor="contact-email" className="text-sm font-medium text-foreground">E-posta</label>
                      <Input
                        id="contact-email"
                        required
                        type="email"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="contact-subject" className="text-sm font-medium text-foreground">Konu</label>
                    <Input
                      id="contact-subject"
                      required
                  ...
                  <div className="space-y-2">
                    <label htmlFor="contact-message" className="text-sm font-medium text-foreground">Mesaj</label>
                    <Textarea
                      id="contact-message"
                      required
                      rows={5}
